        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="left-side">
                        <div class="logo">
                            <img src="assests/img/logo.png" alt="Flight Template">
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <div class="weather-icon">
                                                            <img src="assests/img/weather-icon-03.png" alt="">
                                                        </div>
                                                        <span>32&deg;C</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>Thailand</h6>
                                                        <div class="weather-icon">
                                                            <img src="assests/img/weather-icon-02.png" alt="">
                                                        </div>
                                                        <span>28&deg;C</span>
                                                        <ul class="time-weather">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>India</h6>
                                                        <div class="weather-icon">
                                                            <img src="assests/img/weather-icon-01.png" alt="">
                                                        </div>
                                                        <span>33&deg;C</span>
                                                        <ul class="time-weather">
                                                            <li>6AM <span>26&deg;</span></li>
                ...
                <div class="wrapper">
                    ...
                    <div class="col-md-8">
                        <section id="third-tab-group" class="recommendedgroup">
                                        ...
                                        <div id="owl-suiteroom" class="owl-carousel owl-theme">
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="assests/img/suite-02.jpg" alt="">
                                                    <div class="text-content">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="assests/img/suite-01.jpg" alt="">
                                                    <div class="text-content">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="assests/img/suite-03.jpg" alt="">
                                                    <div class="text-content">
                            ...
                            <div id="swimingpool">
                                <img src="assests/img/swiming-pool.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="massage">
                                <img src="assests/img/massage-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="fitness">
                                <img src="assests/img/fitness-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="event">
                                <img src="assests/img/evening-event.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                    ...
                    <div id="owl-mostvisited" class="owl-carousel owl-theme">
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="assests/img/place-01.jpg" alt="">
                                <div class="text-content">
                                    <h4>River Views</h4>
                                    <span>New York</span>
                                </div>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="assests/img/place-02.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="assests/img/place-03.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="assests/img/place-04.jpg" alt="">
                                <div class="text-content">
